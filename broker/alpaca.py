...
SleepWealth Agent is a local paper/simulation research project. External broker
network access is intentionally unavailable in this build.
"""
...
class AlpacaBroker(BaseBroker):
    """Compatibility stub that cannot connect to Alpaca or submit orders."""
